...
from sklearn.metrics import roc_auc_score, roc_curve, auc,mean_squared_error, mean_absolute_error, confusion_matrix, classification_report, accuracy_score
...
print(mean_absolute_error(y_test,clf_pred))
